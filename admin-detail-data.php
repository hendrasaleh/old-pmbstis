...
//$username = $_GET['user'];
$hasil = $camaba->getDb()->query("SELECT * FROM data_calon_mhs WHERE no_pendaftaran = '$user'");
$data = $hasil->fetchAll();
$rowCount = count($data);
...
<div class="col-md-11">
	...
	<a href="home-admin.php?hal=admin-rekap-data"><button class="btn btn-info">Kembali</button></a>
