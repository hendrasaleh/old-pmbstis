...
<body>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="home-admin.php?hal=admin-rekap-data"><i class="fa fa-desktop "></i>Data Pendaftar</a>
                   </li>
                   <li>
                        <a href="home-admin.php?hal=admin-tampil-data"><i class="fa fa-desktop "></i>Data Pendaftar Per Kota</a>
                   </li>
                    <li>
    ...
    <script type="text/javascript">$('#verify').modal('show')</script>
