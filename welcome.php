...
<div class="row">
	<div class="col-md-8">
		<div class="alert alert-danger">
			Anda belum Login. Silahkan <a href="#loginPage" data-toggle="modal">Login</a> untuk mengisi form pendaftaran atau <a href="#regPage" data-toggle="modal">Register</a> bila anda belum melakukan registrasi.
		</div>
	</div>
</div>
<div class="row">
